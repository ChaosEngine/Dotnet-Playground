...
#
docker run -d --rm -p 8080:5000 --name dotnetplayground --hostname DotnetPlayground --env-file docker-prod.env -v /run/mysqld:/sockets -v $(pwd)/shared:/shared -v /var/www/localhost/htdocs/webcamgallery:/webcamgallery:ro chaosengine/dotnetplayground:alpine
