...
#
docker run -d --rm -p 8080:8080 --name dotnetplayground --hostname DotnetPlayground --env-file docker-prod.env -v /run/mysqld:/sockets -v $(pwd)/shared:/shared -v /var/www/localhost/htdocs/webcamgallery:/webcamgallery:ro chaosengine/dotnetplayground:alpine
