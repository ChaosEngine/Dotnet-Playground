...
self.addEventListener('install', function (event) {
	...
	if (isDev) {
		...
		RESOURCES = RESOURCES.concat([
			...
			'https://cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.18.0/bootstrap-table.min.css',
			'https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/css/bootstrap.min.css',
			'https://cdnjs.cloudflare.com/ajax/libs/blueimp-gallery/3.3.0/js/blueimp-gallery.min.js',
			'https://cdn.jsdelivr.net/npm/video.js@7.10.2/dist/alt/video.core.novtt.min.js',
			'https://cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.18.0/bootstrap-table.min.js',
			//'https://cdn.jsdelivr.net/npm/faker@5.1.0/dist/faker.min.js',//questionable, big script ?
			...
			//'https://cdn.jsdelivr.net/npm/@microsoft/signalr@5.0.2/dist/browser/signalr.min.js',//questionable, inkball ?
			//'https://cdn.jsdelivr.net/npm/msgpack5@5.0.0/dist/msgpack5.min.js',//questionable, inkball ?
			//'https://cdn.jsdelivr.net/npm/@microsoft/signalr-protocol-msgpack@5.0.2/dist/browser/signalr-protocol-msgpack.min.js'//questionable, inkball ?
		]);
	}
