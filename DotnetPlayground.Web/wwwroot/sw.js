...
self.addEventListener('install', function (event) {
	...
	if (isDev) {
		...
		RESOURCES = RESOURCES.concat([
			...
			'https://cdn.jsdelivr.net/npm/video.js@7.13.3/dist/video-js.min.css',
			...
			'https://cdn.jsdelivr.net/npm/video.js@7.13.3/dist/alt/video.core.novtt.min.js',
			...
			//'https://cdn.jsdelivr.net/npm/@microsoft/signalr@5.0.7/dist/browser/signalr.min.js',//questionable, inkball ?
			//'https://cdn.jsdelivr.net/npm/msgpack5@5.3.2/dist/msgpack5.min.js',//questionable, inkball ?
			//'https://cdn.jsdelivr.net/npm/@microsoft/signalr-protocol-msgpack@5.0.7/dist/browser/signalr-protocol-msgpack.min.js'//questionable, inkball ?
		]);
	}
