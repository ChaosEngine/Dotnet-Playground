...
self.addEventListener('install', function (event) {
	...
	if (isDev) {
		...
		RESOURCES = RESOURCES.concat([
			...
			'https://cdnjs.cloudflare.com/ajax/libs/video.js/8.0.4/video-js.min.css',
			...
			'https://cdnjs.cloudflare.com/ajax/libs/video.js/8.0.4/alt/video.core.novtt.min.js',
			'https://cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.21.2/bootstrap-table.min.js',
			//'https://cdn.jsdelivr.net/npm/chance@1.1.10/dist/chance.min.js',
			...
			//'https://cdn.jsdelivr.net/npm/@microsoft/signalr@6.0.10/dist/browser/signalr.min.js',//questionable, inkball ?
			//'https://cdn.jsdelivr.net/npm/msgpack5@6.0.2/dist/msgpack5.min.js',//questionable, inkball ?
			//'https://cdn.jsdelivr.net/npm/@microsoft/signalr-protocol-msgpack@6.0.10/dist/browser/signalr-protocol-msgpack.min.js'//questionable, inkball ?
		]);
	}
