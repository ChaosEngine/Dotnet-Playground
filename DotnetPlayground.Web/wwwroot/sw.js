...
self.addEventListener('install', function (event) {
	...
	if (isDev) {
		...
		RESOURCES = RESOURCES.concat([
			...
			//'https://cdn.jsdelivr.net/npm/@microsoft/signalr@5.0.6/dist/browser/signalr.min.js',//questionable, inkball ?
			//'https://cdn.jsdelivr.net/npm/msgpack5@5.3.2/dist/msgpack5.min.js',//questionable, inkball ?
			//'https://cdn.jsdelivr.net/npm/@microsoft/signalr-protocol-msgpack@5.0.6/dist/browser/signalr-protocol-msgpack.min.js'//questionable, inkball ?
		]);
	}
