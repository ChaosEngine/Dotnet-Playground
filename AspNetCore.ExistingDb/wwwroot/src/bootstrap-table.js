    ...
    _createClass(BootstrapTable, [{
      ...
      value: function initToolbar() {
        ...
        if (o.showColumns) {
          ...
          $keepOpen.find('input').off('click').on('click', function (_ref3) {
      ...
      value: function onSearch() {
        var _ref4 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
            ...
            firedByInitSearchText = _ref4.firedByInitSearchText;
      ...
      value: function initRow(item, i, data, trFragments) {
        ...
        html.push('<tr', Utils.sprintf(' %s', htmlAttributes.length ? htmlAttributes.join(' ') : undefined), Utils.sprintf(' id="%s"', Array.isArray(item) ? undefined : item._id), Utils.sprintf(' class="%s"', style.classes || (Array.isArray(item) ? undefined : item._class)), " data-index=\"".concat(i, "\""), Utils.sprintf(' data-uniqueid="%s"', item[this.options.uniqueId]), Utils.sprintf(' data-has-detail-view="%s"', !this.options.cardView && this.options.detailView && Utils.calculateObjectValue(null, this.options.detailFilter, [i, item]) ? 'true' : undefined), Utils.sprintf('%s', data_), '>');
      ...
      value: function initBody(fixedScroll) {
        ...
        this.$body.find('> tr[data-index] > td').off('click dblclick').on('click dblclick', function (e) {
          ...
          if (e.type === 'click' && _this8.options.detailViewByClick) {
            _this8.toggleDetailView(rowIndex);
          }
      ...
      value: function toggleDetailView(index) {
      ...
      value: function horizontalScroll() {
        ...
        this.$tableBody.off('scroll').on('scroll', function (_ref5) {
      ...
      value: function check_(checked, index) {
        ...
        if ($el.is(':radio') || this.options.singleSelect || this.options.multipleSelectRow && !this.multipleSelectRowCtrlKey && !this.multipleSelectRowShiftKey) {
          ...
          try {
            for (var _iterator8 = this.options.data[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
              var r = _step8.value;
      ...
      value: function showColumn(field) {
        ...
        fields.forEach(function (field) {
          _this20.toggleColumn(_this20.fieldsColumnsIndex[field], true, true);
        });
      }
    }, {
      key: "hideColumn",
      value: function hideColumn(field) {
        ...
        var fields = Array.isArray(field) ? field : [field];
        fields.forEach(function (field) {
          _this21.toggleColumn(_this21.fieldsColumnsIndex[field], false, true);
        });
      }
    }, {
      ...
      value: function expandRow(index) {
        ...
        var detailFormatter = this.header.detailFormatters[index - 1] || this.options.detailFormatter;
